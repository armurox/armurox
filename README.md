...
I'm a Hopkins Mathematics graduate with a passion for programming, finance and machine learning. My proficiences include JavaScript, Python, C, C++, SQL (specifically SQLite) and experience with 2 JavaScript Frameworks (BOOTSTRAP and JQuery) and a Python Framework (Flask) for Web Development. I also have experience with machine learning and deep learning libraries like scikit-learn and Tensorflow. On this page, you can find repositories of interesting problems that I'm working on, from competitive programming, to bigger projects, and even any mathematics conjectures I may find interesting.
